        ...
        <div className="rounded-2xl row-start-1 col-span-3 flex justify-center md:items-end md:justify-between md:border-0 md:pb-0 border-gray-200 border-b-2 pb-5 mt-1">
          <div className="flex gap-3 flex-col md:flex-row items-center">
            <Image
              ...
              height={53}
              alt="icap-logo"
              className="md:w-30 md:h-8 w-22 h-6 "
            />
            <h5 className="font-bold m-0 text-base md:text-xl">
              آیکپ، سامانه دستیار هوشمند خودرو
            </h5>
          </div>
        ...
        <div className="md:bg-gray-100 rounded-2xl p-3 pt-4 md:pt-3 row-start-2 col-span-3">
          ...
          <div className="flex flex-col pr-2 pt-1 lg:flex-row lg:flex-wrap justify-start gap-4 md:gap-6">
            <a href="" className="flex items-center gap-3">
              <Image
                src="/images/icons/sms-tracking.png"
                width={24}
                height={24}
                alt="sms-tracking"
                className="w-5 h-5"
              />
              <p className="text-sm md:text-sm text-gray-800 hover:text-primary">
                info@r-icap.com
              </p>
            </a>
            {/* call  */}
            <a href="" className="flex items-center gap-3">
              <Image
                src="/images/icons/call-calling.png"
                width={24}
                height={24}
                alt="sms-tracking"
                className="w-5 h-5"
              />
              <p className="text-sm md:text-sm text-gray-800 hover:text-primary">
                {toFarsiNumber("0912346789")}
              </p>
              <p className="text-sm md:text-sm text-gray-800 hover:text-primary">
                {toFarsiNumber("09301234567")}
              </p>
            </a>
            {/* addres  */}
            <a href="" className="flex items-center gap-3">
              ...
              <p className="text-sm md:text-sm text-gray-800 hover:text-primary">
                {" "}
                تهران، خیابان آزادی، جنب پارک اوستا، پلاک ۱۵۶، ساختمان رایان
                خودرو
              </p>
            </a>
          </div>
